...
/*
public class RecyclerAdapterSalesHome {
}
*/
...
public class RecyclerAdapterSalesHome  extends    RecyclerView.Adapter<RecyclerAdapterSalesHome .viewitem> {
    ...
    public RecyclerAdapterSalesHome (Context c, List<Offers> item) {
        items = item;
        context = c;
    ...
    class viewitem extends RecyclerView.ViewHolder {
        ...
        private TextView content,storeName;
