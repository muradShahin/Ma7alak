...
public class RecyclerAdapterStoresFull extends    RecyclerView.Adapter<RecyclerAdapterStoresFull.viewitem> {
    ...
    public RecyclerAdapterStoresFull(Context c, List<StoreModel> item)
    {
        items=item;
        context=c;
    ...
    public viewitem onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_stores_full, parent, false);
    ...
    public void onBindViewHolder(final viewitem holder, final int position) {
        ...
        holder.storeImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CurrentLastPos.allStores_last_pos=position;
                Navigation.findNavController(v).navigate(R.id.action_allStores_to_insideStoreFragment);
            }
        });
